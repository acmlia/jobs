...
class TuningRegressionPrecipitation:
    ...
    def  create_model(self, neurons=5):
        ...
        model = Sequential()
        model.add(Dense(neurons, input_dim=11, kernel_initializer='uniform', activation='linear'))
...
#    joblib.dump(grid_result, 'model_trained_regression_precipitation_W2.pkl')
    loaded_model = joblib.load('/media/DATA/tmp/git-repositories/jobs/model_trained_regression_precipitation_W2.pkl')
