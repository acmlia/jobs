...
#    joblib.dump(grid_result, 'model_trained_regression_precipitation_R3.pkl')
    loaded_model = joblib.load('/media/DATA/tmp/git-repositories/jobs/model_trained_regression_precipitation_R3.pkl')
...
#    accuracy, bias, pod, pofd, far, csi, ets, hss, hkd = skills.metrics(y_test, y_pred)
    ...
    print("Grid best score: ", loaded_model.best_score_)
    print("Grid score function: ", loaded_model.score(x_test,y_test))