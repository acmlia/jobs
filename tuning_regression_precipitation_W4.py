...
#    joblib.dump(grid_result, 'model_trained_regression_precipitation_W4.pkl')
    loaded_model = joblib.load('/media/DATA/tmp/git-repositories/jobs/model_trained_regression_precipitation_W4.pkl')
